...
class Environments(unittest.TestCase):
    def __init__(self, debug_enable=False, path_bearing_deg=0.0, path_curvature=0.0, stop_every_1sec=False, vehicle_speed=20.0, vehicle_bearing_deg=0.0, world_size=300.0, nominal_airspeed=15.0, reference_airspeed=1.0):
        ...
        self.env = gym.make('multicopter-fixedwing-lateral-npfg', vehicle_type = 'multicopter', nominal_airspeed=nominal_airspeed, reference_airspeed=reference_airspeed, world_size = world_size, screen_size = [screen_width, screen_height], render_mode='human', DEBUG = debug_enable)
